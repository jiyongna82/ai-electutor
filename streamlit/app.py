...
# 2. 검색 엔진 로봇 대응 (사이트맵은 메인 워드프레스 참조)
...
st.set_page_config(
    ...
    menu_items={
        ...
        'About': "# VoltMaster\n현직 데이터센터 운용 전문가가 만든 실무 계산기 및 AI 튜터 플랫폼입니다."
    }
)
...
st.markdown("""
    <style>
        ...
        header[data-testid="stHeader"] { background-color: rgba(0,0,0,0) !important; border-bottom: none !important; z-index: 1 !important; }
        [data-testid="stStatusWidget"], #MainMenu, .st-emotion-cache-zq59db { display: none !important; }
        
        div[data-testid="stSidebarCollapsedControl"] {
            position: fixed !important; top: 60px !important; left: 15px !important;
            z-index: 999999 !important; background-color: #E67E22 !important;
            border-radius: 8px !important; padding: 5px !important;
            box-shadow: 2px 2px 10px rgba(0,0,0,0.2) !important;
            display: flex !important; visibility: visible !important;
        }
        div[data-testid="stSidebarCollapsedControl"] button svg { fill: white !important; width: 25px !important; height: 25px !important; }
        ...
        .section-header { font-size: 1.5rem !important; font-weight: 800; color: #1E293B !important; margin: 20px 0 10px 0 !important; border-left: 5px solid #E67E22; padding-left: 10px; }
        .card-anchor { text-decoration: none !important; color: inherit !important; display: block; margin-bottom: 10px; }
        .clickable-card { background-color: #FFFFFF !important; transition: all 0.2s ease; box-shadow: 0 2px 6px rgba(0,0,0,0.08); border-radius: 12px; border: 1px solid #E2E8F0; text-align: center; display: flex; flex-direction: column; justify-content: center; align-items: center; }
        ...
        /* 워드프레스 연동 특별 버튼 */
        .wp-button { background-color: #1E293B; color: white !important; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block; margin-top: 15px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: 0.3s; }
        .wp-button:hover { background-color: #E67E22; transform: translateY(-2px); }
    </style>
""", unsafe_allow_html=True)
...
def render_main_home():
    st.markdown('''
        <div class="hero-container">
            ...
            <a href="https://ai-electutor.com" class="wp-button" target="_blank">📝 전기 기술 블로그 (최신 기술 칼럼 보기)</a>
        </div>
    ''', unsafe_allow_html=True)
